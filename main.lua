			...
			local teleportScript = [[
				...
				if shared.VapeDeveloper or shared.VoidDev then
					if isfile('vape/NewMainScript.lua') then
						...
						loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/VWRewrite/main/NewMainScript.lua", true))()
					end
				else
					loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/VWRewrite/main/NewMainScript.lua", true))()
				end
...
local VWFunctions = loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/VWRewrite/main/libraries/VoidwareFunctions.lua", true))()
