...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/aidanqm/VWRewrite')
	end)
...
local url = shared.RiseMode and "https://github.com/VapeVoidware/VWRise/" or "https://github.com/aidanqm/VWRewrite"
local commit = "main"
writefile(baseDirectory.."commithash2.txt", commit)
commit = '5d2255b3c995d0d62c8cf55db9bcf53ba0e91564'
...
local function vapeGithubRequest(scripturl, isImportant)
    ...
    local url = (scripturl == "MainScript.lua" or scripturl == "GuiLibrary.lua") and shared.RiseMode and "https://raw.githubusercontent.com/VapeVoidware/VWRise/" or "https://raw.githubusercontent.com/aidanqm/VWRewrite/"
