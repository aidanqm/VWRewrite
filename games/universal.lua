...
local hash = loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/VWRewrite/main/libraries/hash.lua", true))()
--pload('libraries/hash.lua', true, true)
--loadstring(downloadFile('vape/libraries/hash.lua'), 'hash')()
local prediction = loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/VWRewrite/main/libraries/prediction.lua", true))()
--pload('libraries/prediction.lua', true, true)
--loadstring(downloadFile('vape/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/VWRewrite/main/libraries/entity.lua", true))()
